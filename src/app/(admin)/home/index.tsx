    ...
    <View style={styles.homeContainer}>
      ...
      <View style={styles.summaryContainer}>
        ...
        <View style={styles.income}>
          <Text style={{ color: Colors.light.background }}>Ngày 22, tháng 4 Năm 2024</Text>
          <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            <Text style={{ fontSize: 30, fontWeight: "bold", color: Colors.light.background }}>900,000Đ</Text>
            <Text style={{ fontSize: 15, color: Colors.light.background }}>15% <FontAwesome
              name="arrow-up"
              size={15}
              color={Colors.light.background}
              style={{ marginRight: 15 }} /></Text>
          </View>
        </View>
      </View>
      <View style={styles.serviceContainer}>
        ...
        < View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", marginTop: 10 }}>
          ...
          <View style={styles.category}>
            <View style={{ backgroundColor: "#f1f3f2", width: 70, height: 70, borderRadius: 40, justifyContent: "center", alignItems: "center" }}>
              <Image source={require('../../../../assets/images/discount.png')} style={{ height: 40, width: 40 }} />
            </View>
            <Text style={styles.categoryText}>Giảm giá</Text>
          </View>
          <View style={styles.category}>
            <View style={{ backgroundColor: "#f1f3f2", width: 70, height: 70, borderRadius: 40, justifyContent: "center", alignItems: "center" }}>
              <Image source={require('../../../../assets/images/checklist.png')} style={{ height: 40, width: 40 }} />
            </View>
